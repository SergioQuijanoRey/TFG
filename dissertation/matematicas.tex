...
\begin{frame}{Tarea de aprendizaje}
	...
	\begin{itemize}
		...
		\item Representamos las imágenes de entrada como \textbf{parches}, $(\nv{x_1}, \ldots, \nv{x_N})$ con $\nv{x_i} \in \R^S$. Esta representación se utiliza en la práctica \doblecita{matematicas:vit}.
...
\begin{frame}{Función de puntuación}
	...
	\begin{itemize}
		...
		\item Expresamos las combinaciones lineales finitas como:
		      ...
		      \end{equation}
		\item En \doblecita{matematicas:principal} se justifica empíricamente que al trabajar con imágenes podemos tomar $M=100$ con lo que se verifica:
...
\begin{frame}{Conclusiones}
	\begin{itemize}
		...
		\item Hemos dado información precisa sobre cómo de frecuente ocurre este hecho (casi por doquier). Otros trabajos \doblecita{matematicas:descomposicion_ht} únicamente dan ejemplos concretos en los que esto ocurre.
	\end{itemize}
\end{frame}
