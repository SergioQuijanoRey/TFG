...
\end{figure}
\todo{PMesejo: borrar esta figura}
\todo{Aprovechar para borrar todas las figuras de WANDB}
...
Por tanto, aunque una mejora de cómputo sea muy buena, si se realiza sobre una porción de código con un valor de $f$ bajo, el impacto no será relevante. Es decir, no debemos fijarnos únicamente en lo buena que sea una optimización, sino que también debemos encontrar aquellas partes del código que mayor tiempo de cómputo (mayor valor de $f$) estén suponiendo. Esto justifica el enfoque que empleamos en la \sectionref{isec:optimizacion_codigo}.
...
% TODO -- esto es de lo último que revisé en el último borrador de informática
