...
\subsection{Selección de triples y funciones de pérdida}
...
\todo{End to end learning sin usar funciones auxiliares que introducen gran complejidad. Estamos optimizando directamente el embedding}
\todo{No hay un paso adicional en el ciclo de aprendizaje, mas simplicidad}
\todo{Regularizamos la dificultad de los triples}
\todo{Aceleramos los computos. La red aprende sobre batches actualizados al maximo por la ultima snapshot de la red}
\todo{Hemos podido controlar los triples que realmente no estan aportando nada}
\todo{Inconveniente: tenemos que controlar los valores P, K, hiperparametros muy importatnes que tendremos que hipertunear}
\todo{Inconveniente: tenemos que tener cuidado con el tamaño de P*K por los tiempos de computo. tambien, memoria ram que puede overflowear}
\todo{Inconveniente: triplet loss poco popular, por lo que ha habido mas estudio en otras areas, mirar el cite de la seccion ventajas}
\todo{Inconveniente: si queremos usar K grande, el dataset lo tiene que permitir, hemos visto este problema en lfw}


% TODO -- seguir por aqui
% TODO -- borrar la siguiente seccion e incluirla en esta que estamos escribiendo
