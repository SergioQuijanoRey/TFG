...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{informatica/neurona_mlp}
...
Capa de agrupación (pooling): Después de la convolución, las capas de agrupación reducen la dimensionalidad de las características al resumir información en regiones más grandes. Esto ayuda a disminuir la cantidad de parámetros y a hacer que la red sea más invariante a pequeñas traslaciones en los datos de entrada.

Capas totalmente conectadas: Las características extraídas se alimentan a través de capas totalmente conectadas que realizan tareas de clasificación o regresión, dependiendo de la aplicación.
