...
La \textbf{visión por computador} es una disciplina que busca generar modelos que puedan comprender, interpretar y utilizar información visual para resolver ciertos problemas. Esto involucra ciertas tareas, como pueden ser la adquisición de imágenes digitales, procesado de imágenes, detección de características... \cite{informatica:cv_modern_approach}
% TODO -- seguir por aqui
% TODO -- mencionar que interesca muchas areas de informatica, como ML optiometria CS ...

\subsection{Aprendizaje por la máxima pendiente}
