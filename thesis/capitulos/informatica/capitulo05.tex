...
\subsection{Aumento de datos} \label{isec:aumentado_datos}

\todo{PMesejo: por qué viene esto en implementación}
...
\end{figure}
\todo{PMESEJO: apenas se ve esta figura}

\section{Optimización del código} \label{isec:optimizacion_codigo}
\todo{PMESEJO: mover a un anexo}
