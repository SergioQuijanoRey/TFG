...
En \sectionref{isec:hptuning_kfold_cross_validation} hemos descrito detalladamente el proceso para la selección de hiperparámetros y en \sectionref{isec:hp_tuning} hemos descrito cómo implementamos este proceso. En resumen, utilizamos la técnica \textit{K-Fold Cross Validation} para guiar la búsqueda de los mejores hiperparámetros.
\todo{Cambiar esto porque es mentira. Estoy usando hold-out por la carga de \textit{KFOLD Cross Validation}}.
