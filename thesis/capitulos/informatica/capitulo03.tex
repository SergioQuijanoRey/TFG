...
% TODO -- seguir por aqui ahora que he modificado algo los diagramas
...
\begin{figure}[H]
    ...
    \caption{Resultados de la búsqueda en \textit{SCOPUS} usando los \textit{keywords} del \coderef{code:scopus_search}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Resultados de la búsqueda en \textit{SCOPUS} usando los \textit{keywords} del  \coderef{code:scopus_search_tripletloss}}
\end{figure}
