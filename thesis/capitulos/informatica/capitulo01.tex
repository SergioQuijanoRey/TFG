...
\end{itemize}
\todo{PMESEJO: estas características son inherentes a los problemas de visión por computador y redes convolucionales / redes profundas. Tengo que reparafrasear el parrafo previo a los bullet points}
...
\todo{Introducir una referencia a la sección en la que desarrollamos la variante técnica}
