...
Para organizar todas las tareas de cada iteración, que nacen en las fases de análisis, diseño e implementación, usamos la \textbf{metodología \textit{Kanban}}. En dicha metodología se usa un tablero, en el que tarjetas que representan tareas a realizar se colocan sobre columnas que representan distintos estados. Usamos cuatro estados:
...
Comenzamos a desarrollar el proyecto en Febrero de 2022. En los meses ??? tenemos planeado dedicar X cantidad de horas. En los meses de Julio, Agosto y Septiembre, planeamos dedicar Y horas semanales.


% TODO -- descomentar esta imagen cuando la generemos
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{informatica/diagrama_gannt}
%     \caption{Diagrama de \textit{Gantt} que describe la planificación original del proyecto}
% \end{figure}
En cuanto a la planificación económica

% TODO -- Diagrama de Gannt
% TODO -- gasto económico supuesto
%      -- Salario de un investigador: 35€ / h
%      -- Lo que me cuesta el portátil
%      -- Servidores nGPU
%      -- Usar los commits de github para poner los diagramas
