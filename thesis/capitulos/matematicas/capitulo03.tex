...
Como hemos justificado, tenemos que escoger una familia de funciones de representación que sea numerable y además total. Las opciones más usadas en la práctica del aprendizaje automático son:

\begin{enumerate}
    \item Wavelets
    \item Gaussiana con matriz de covarianzas diagonal:
