...
\todo{Definir todo lo que nos hace falta: feature maps, pooling, linear dense layer, bloque convolucional, pooling tipo producto, pooling tipo global, product pooling con tamaño de ventana 2}
