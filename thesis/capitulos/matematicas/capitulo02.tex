...
\todo{JMERI: pregunta del tribunal: tiene base matemática o es puramente experimental? Escribir ya la respuesta, porque en el paper de referencia hacen el desarrollo matemático que justifica este valor}
