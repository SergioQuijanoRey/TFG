...
\begin{itemize}
    \item Dimensiones de la convolución: podemos aplicar una convolución de tamaño $1 \times 1$, en la que en cada paso sólo nos fijamos en un elemento del tensor. O de tamaño $3 \times 3$, en la que en cada paso nos fijamos en 9 elementos del tensor. O cualquier tamaño, que normalmente se toma impar para poder centrar la convolución sobre cada píxel.
    \item \textit{Stride}: tamaño de salto al mover la convolución por el tensor. Podemos aplicar nuestra convolución dando saltos de un píxel o dando saltos de más píxeles.
