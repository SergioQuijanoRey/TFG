...
En el modelo \textit{HT} es muy fácil imponer los coeficientes compartidos, teniendo en cuenta los comentarios que hemos hecho en \customref{sec:modelo_ht}. Consideremos la ecuación de la capa $l$:
