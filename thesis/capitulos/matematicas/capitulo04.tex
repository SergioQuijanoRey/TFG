...
\begin{proof}
	...
	Esta demostración es prácticamente la misma que la usada en \propref{proposicion:descomposicion_cp}. Ahora tenemos que $M_1 = M_2 = \ldots = M_N = M$ y nuestro conjunto de vectores es:
    ...
    Teniendo esto en cuenta, desarrollamos la prueba
