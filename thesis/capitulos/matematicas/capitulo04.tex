...
Respecto a la segunda pregunta, ya sabemos que en el caso de imponer coeficientes compartidos, el modelo \textit{HT} puede representar ciertos $\mathcal{A}^y$ no simétricos que el modelo \textit{CP} será incapaz de representar.
