...
\newcommand{\miTitulo}{Estudio sobre la expresividad de las redes neuronales profundas y no profundas a través de análisis tensorial y reconocimiento facial invariante a la edad introduciendo una variante \textit{online} en \textit{Triplet Loss}\xspace}
...
\setpartpreamble[c][0.75\linewidth]{
    ...
    En esta primera parte del trabajo, introduciremos dos modelizaciones matemáticas muy cercanas a los modelos reales que se usan en la práctica del aprendizaje automático. Un modelo será no profundo (\entrecomillado{shallow}) y otro será profundo. La distinción entre los dos modelos viene dada por la descomposición tensorial que usamos para construir el tensor de coeficientes. Demostraremos que los modelos profundos son más eficientes que los modelos no profundos en la mayoría de los casos. Es más, demostraremos que los modelos no profundos no pueden aproximar de forma eficiente a los modelos profundos, en la mayoría de los casos.
}
...
\cleardoublepage\part{Reconocimiento facial invariante a la edad introduciendo una variante \textit{online} en \textit{Triplet Loss}}
...
% \input{capitulos/informatica/capitulo_borrado.tex} % TODO -- borrar
