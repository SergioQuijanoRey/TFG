...
\setpartpreamble[c][0.75\linewidth]{
	...
	En esta primera parte del trabajo, introduciremos dos modelizaciones matemáticas muy cercanas a los modelos reales que se usan en la práctica del aprendizaje automático. Un modelo será somero (\entrecomillado{shallow}) y otro será profundo (\entrecomillado{deep}). La distinción entre los dos modelos viene dada por la descomposición tensorial que usamos para construir el tensor de coeficientes asociado a una red neuronal. Demostraremos que los modelos profundos son más eficientes que los modelos no profundos en la mayoría de los casos. Es más, demostraremos que los modelos no profundos no pueden aproximar de forma eficiente a los modelos profundos.
}
...
\input{capitulos/matematicas/capitulo04}
\input{capitulos/matematicas/capitulo05}
\input{capitulos/matematicas/capitulo06}

\setpartpreamble[c][0.75\linewidth]{
	% Deja un espacio vertical en la parte superior
	\bigskip

	En esta segunda parte del trabajo, introduciremos un nuevo método para computar el \entrecomillado{Triplet Loss}. Aplicaremos este nuevo método a una tarea de reconocimiento facial invariante a cambios de edad e introduciremos una solución original a un problema en el diseño de la función de pérdida que produce mejoras muy significativas en el rendimiento.
}
...
\input{capitulos/informatica/capitulo01} % introduccion
\input{capitulos/informatica/capitulo02} % fundamentos teoricos
\input{capitulos/informatica/capitulo03} % estado del arte
\input{capitulos/informatica/capitulo04} % materiales y metodos
\input{capitulos/informatica/capitulo05} % Implementacion
\input{capitulos/informatica/capitulo06} % Experimentacion
\input{capitulos/informatica/capitulo07} % Conclusiones

% Configuración del apéndice
\appendix
\pdfbookmark[-1]{Apéndices}{appendix}

\input{apendices/informatica/modulos_codigo.tex}
\input{apendices/informatica/optimizacion}
